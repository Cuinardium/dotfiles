...
vim.list_extend(bundles, vim.split(vim.fn.glob(home .. "/Developer/vscode-java-test/server/*.jar"), "\n"))
...
local config = {
    ...
    cmd = {
        ...
        -- 💀
        "/usr/lib/jvm/java-21-openjdk/bin/java", -- or '/path/to/java21_or_newer/bin/java'
    ...
    on_attach = Load_Plugin('nvim-navic').attach,
    capabilities = Load_Plugin('blink.cmp').get_lsp_capabilities(),
