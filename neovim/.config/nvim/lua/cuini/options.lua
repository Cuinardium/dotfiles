-- Algunas configuraciones, mas info con :help options
-- "Campo" de opciones
local o = vim.opt
...
vim.cmd [[set fillchars+=eob:\ ]] -- remove tildes at the end of the file

-- Tambien se pueden setear opciones usando vimscript:
